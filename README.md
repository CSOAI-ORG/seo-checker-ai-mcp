<!-- mcp-name: CSOAI-ORG/seo-checker-ai-mcp -->
[![MCP Scorecard: 86/100](https://img.shields.io/badge/proofof.ai-86%2F100-5b21b6)](https://proofof.ai/scorecard/seo-checker-ai-mcp.html)
...
```json
{
  "mcpServers": {
    "seo-checker-ai-mcp": {
      "command": "uvx",
      "args": ["seo-checker-ai-mcp"]
    }
  }
}
```

Or: `pip install seo-checker-ai-mcp` then run the `seo-checker-ai-mcp` command (stdio transport).

## Examples

Once configured, ask your assistant, for example:
- "Use `analyze_title` to …"
- "Use `check_meta_description` to …"
- "Use `validate_schema_markup` to …"
